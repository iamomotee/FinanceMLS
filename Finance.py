...
st.markdown("<h4 style = 'margin: -30px; color: #416D19; text-align: center; font-family: Self Deception'> Built by The Future is NOW </h4>", unsafe_allow_html = True)
st.markdown("<br>", unsafe_allow_html= True)

st.image('Financial.png', width = 700)
...
st.sidebar.image('user icon.png', width = 300, caption = 'Welcome User')
st.sidebar.divider()
